...
<div align=center>
<img decoding="async" src="./Readme_File/Poster_16_9.png" width="50%" >
</div>
...
&emsp;&emsp;根据汉字国标库绘图，同一字体生成976张图片作为训练集，生成244张图片作为训练中准确率的测试集，总共3755个汉字，训练集（不包含验证集）共3664880个文件，每个汉字有对应876张训练集图片和244张验证集图片，根据AlexNet要求每张图片大小应为227*227。
